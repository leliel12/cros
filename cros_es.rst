:Authors: Juan B Cabral Diego E Ferreyra Torrent
...
**Escudo Pequeño de Madera.**
    ...
    * **Aclaración:** Cuando un personaje que porta un escudo es atacado desde
      ...
      se realiza una tirada de (reflejos + 1d10) para determinar si logra
      bloquear el ataque con el escudo, el valor necesario para bloquear de los
      escudos pequeños de Madera es 12 o + desde el frente y 13 o + desde el
      flanco.
    * **Constitución Mínima:** 1
    * **Protección:** +3
...
premisas.
    ...
    #. Por simplicidad plantearemos un hipotético jugador, el cual intenta
       desarrollar su **PJ** (Personaje del jugador) a través de una charla con
       el **DJ** (Director del Juego).
...
de la **Tabla Descripción**:
    ...
    * ``Edad:`` 43 años.
    * ``Ojos:`` Negros.
    * ``Cabello:`` Castaño oscuro con corte romano.
    * ``Profesión:`` Policía.
    * ``Altura:`` 1,90 m.
    * ``Peso:`` 85 Kg.
    * ``Arquetipo:`` Rufián de Buen Corazón. (Entre el jugador y el director
      ...
      moral.)
    * ``Otros:`` Nariz torcida, barba mal afeitada y cicatriz en la frente.
...
| |                                          |                                        | Corte romano``                    | |
| +------------------------------------------+----------------------------------------+-----------------------------------+ |
| | **Profesión:** ``Policía``               | **Altura:** ``1.90 m.``                | **Peso:** ``85 Kg.``              | |
| +------------------------------------------+----------------------------------------+-----------------------------------+ |
| | **Arquetipo:**  ``Rufián de buen         | **Otros:**  ``Nariz torcida, barba mal afeitada y cicatriz en la frente``  | |
| | corazón``                                |                                                                            | |
| +------------------------------------------+----------------------------------------------------------------------------+ |
+---------------------------------------------------------------------------------------------------------------------------+
| +-----------------------------------------------------------+-----------------------------------------------------------+ |
...
| | +------------------+------------+-----------+-----------+ | +---------------------+---------+-----------------------+ | |
| | | **Constitución** | ``7``      |           | ``7``     | | | ``Artes Marciales`` | ``7``   | ``FUE+1d10``          | | |
| | +------------------+------------+-----------+-----------+ | +---------------------+---------+-----------------------+ | |
...
| | +=======================================================+ | +-------------+-------------+-------------+-------------+ | |
| | | ``Chaleco Antibalas``                                 | | | **Nombre**                | **Fórmula**               | | |
| | +-------------------------------------------------------+ | +===========================+===========================+ | |
...
| | | .. image:: img/pedro_grifo.png                        | | +=================+===================+=================+ | |
| | |   :align: center                                      | | |  ``+25``        | ``55``            | ``55``          | | |
| | |   :scale: 25 %                                        | | |                 |                   |                 | | |
| | |                                                       | | |                 |                   |                 | | |
| | |                                                       | | |                 |                   |                 | | |
| | |                                                       | | +-----------------+-------------------+-----------------+ | |
